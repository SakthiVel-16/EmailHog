...
A full-featured email sandbox application built with **Spring Boot 3.4.1** that simulates a Email-like inbox interface. It captures incoming emails, stores them in MongoDB Atlas, and provides AI-powered spam analysis using Google's Gemini API.
